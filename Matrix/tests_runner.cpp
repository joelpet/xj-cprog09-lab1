...
public:
 TestDescription_MatrixTestSuite_test_test() : CxxTest::RealTestDescription( Tests_MatrixTestSuite, suiteDescription_MatrixTestSuite, 28, "test_test" ) {}
...
public:
 TestDescription_MatrixTestSuite_test_direct_access() : CxxTest::RealTestDescription( Tests_MatrixTestSuite, suiteDescription_MatrixTestSuite, 32, "test_direct_access" ) {}
